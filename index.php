...
<head>
    ...
    <title>نظام إدارة المعاملات | Workflow System</title>
    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <div class="nav-tabs">
                ...
                <button class="nav-tab" data-tab="transactions">المعاملات</button>
            ...
            <div class="nav-actions">
                ...
                <button class="notification-btn" title="التنبيهات">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path>
                        <path d="M13.73 21a2 2 0 0 1-3.46 0"></path>
                    </svg>
                    <span class="notification-badge" id="notification-badge" style="<?= $stats['urgent'] > 0 ? '' : 'display:none' ?>">
                        <?= $stats['urgent'] ?>
                    </span>
                </button>
