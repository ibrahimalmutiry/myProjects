...
<head>
    ...
    <title>إنشاء كلمة المرور | نظام إدارة المعاملات</title>
...
<body>
                ...
                <form id="registerForm">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            <input type="password" class="form-input" id="password" placeholder="أدخل كلمة المرور" required minlength="6">
    ...
    document.addEventListener('DOMContentLoaded', async function() {
        try {
            ...
            document.getElementById('loadingState').innerHTML = '<p style="color: var(--accent-red);">خطأ في الاتصال</p>';
        }
    });
