...
const i18n = {
  ...
  en: {
    ...
    'ربط وديعة جديدة': 'Link New Deposit',
    ...
    'حساب الايداعات': 'Deposits Account',
    ...
    // ── حالات الحسابات البنكية ────────────────────────────────
    'نشط': 'Active',
    'نشطة': 'Active',
    'غير نشط': 'Inactive',
    'مسجّل اليوم': 'Recorded Today',
    'لم يُسجَّل': 'Not Recorded',
    'سجل': 'Record',
    'سجلات': 'Records',
    'لا توجد حسابات': 'No accounts',
    'أضف حساباً جديداً': 'Add a new account',
    'لا توجد حسابات بنكية نشطة': 'No active bank accounts',
    'لا توجد استثمارات نشطة': 'No active investments',
    ...
    '⏰ مستحقة الإغلاق': '⏰ Due for Closure',
    '🔔 قريبة الاستحقاق': '🔔 Near Maturity',
    'اسم الوديعة': 'Deposit Name',
    'الحساب المصدر': 'Source Account',
    'المدة (أيام)': 'Duration (Days)',
    'تاريخ البداية': 'Start Date',
    'تاريخ الاستحقاق': 'Maturity Date',
    'حساب الإعادة': 'Return Account',
    'الافتراضي نفس الحساب': 'default same account',
    'نفس حساب الوديعة': 'Same deposit account',
    'يُولَّد تلقائياً': 'auto-generated',
    'ربط الوديعة': 'Link Deposit',
    'البداية': 'Start',
    'الربح الجزئي الفعلي': 'Actual Partial Return',
    'إجمالي المُعاد': 'Total Returned',
    'سبب الإلغاء': 'Cancellation Reason',
    'يرجى ذكر السبب': 'Please state the reason',
    'إلغاء الوديعة': 'Cancel Deposit',
    'تراجع': 'Back',
    'تحذير': 'Warning',
    'الإلغاء المبكر': 'Early cancellation',
    'سيُعاد للحساب': 'will be returned to the account',
    'يمكنك إضافة ربح جزئي إن وُجد': 'You may add a partial return if applicable',
    'إغلاق واسترداد': 'Close & Redeem',
    'تأكيد الإغلاق والاسترداد': 'Confirm Closure & Redemption',
    'اتركه كما هو إذا مطابق للمتوقع': 'Leave as is if matching expected',
    'تعديل الوديعة': 'Edit Deposit',
    'اسم أو وصف الوديعة': 'Deposit name or description',
    'عند الاستحقاق': 'Upon maturity',
    'حفظ التعديلات': 'Save Changes',
    'مثال: وديعة الرواتب Q1': 'Example: Payroll Deposit Q1',
    'مكتمل': 'complete',
    'متأخر': 'overdue by',
    'بعد': 'in',
    'أصل': 'principal',
    'ربح جزئي': 'partial return',
    'مستحقة': 'Overdue',
    'قريبة': 'Near Maturity',
    'إلغاء مبكر': 'Early Cancellation',
    ...
    'إضافة': 'Add',
    'مختصر': 'Short',
    'المالية — الدفع': 'Finance — Payment',
    'نُفِّذ بواسطة': 'Executed by',
    'المشتريات — إنشاء حجز': 'Procurement — Create Reservation',
    'الجهة / المستفيد': 'Entity / Beneficiary',
    'بيانات الدفع': 'Payment Info',
